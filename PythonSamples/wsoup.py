...
class wSoupCrawler:
	"""
		...
		Functions list:
				findtag: parameter -> tagname, return -> position
				catchbodytag: 
					parameters: tagname, tag_class_div, tag_id_div, tag_class_css, tag_id_css
				
				Private function: starttag, endtag ("abre e frecha tag") retorna posição de abertura e fechamento da tag.
